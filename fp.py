...
##WRZ tweaked for my app by removing unnecesary imports.
##WRZ might have a copyright problem.
...
"""
Give this your query and result, and it returns zero..two track ids.
"""
...
"""
One response object is:
  .header = dict of misc data
  .results = array of dicts; each dict holds:
    "score" = ?
    "track_id" = id of possible match
    fp,length,artist,release,track = from metadata, if available
"""
